...
namespace Harness
{
    public class Program
    {
        ...
        public static Sudoku CreateWikipediaSudoku()
        {
            // https://en.wikipedia.org/wiki/Sudoku#/media/File:Sudoku_Puzzle_by_L2G-20050714_standardized_layout.svg
            Sudoku sudoku = new Sudoku();
            sudoku.SetValue(0, 0, 5).SetValue(1,0,3).SetValue(4,0,7).SetValue(0,1,6).SetValue(3,1,1).SetValue(4,1,9).SetValue(5,1,5).SetValue(1,2,9).SetValue(2,2,8).SetValue(7,2,6).SetValue(0,3,8).SetValue(4,3,6).SetValue(8,3,3).SetValue(0,4,4).SetValue(3,4,8).SetValue(5,4,3).SetValue(8,4,1).SetValue(0,5,7).SetValue(4,5,2).SetValue(8,5,6).SetValue(1,6,6).SetValue(6,6,2).SetValue(7,6,8).SetValue(3,7,4).SetValue(4,7,1).SetValue(5,7,9).SetValue(8,7,5).SetValue(4,8,8).SetValue(7,8,7).SetValue(8,8,9);
            return sudoku;
        }
        ...
        public static KenKen CreateWikipediaKenKen()
        {
            KenKen kenKen = new KenKen();
            kenKen.AddBlock(new int[] { 0, 0, 0, 1 }, 11, Operator.Add)
                .AddBlock(new int[] { 1, 0, 2, 0 }, 2, Operator.Divide)
                .AddBlock(new int[] { 3, 0, 3, 1 }, 20, Operator.Multiply)
                .AddBlock(new int[] { 4, 0, 5, 0, 5, 1, 5, 2 }, 6, Operator.Multiply)
                .AddBlock(new int[] { 1, 1, 2, 1 }, 3, Operator.Subtract)
                .AddBlock(new int[] { 4, 1, 4, 2 }, 3, Operator.Divide)
                .AddBlock(new int[] { 0, 2, 1, 2, 0, 3, 1, 3 }, 240, Operator.Multiply)
                .AddBlock(new int[] { 2, 2, 3, 2 }, 6, Operator.Multiply)
                .AddBlock(new int[] { 2, 3, 2, 4 }, 6, Operator.Multiply)
                .AddBlock(new int[] { 3, 3, 3, 4, 4, 4 }, 7, Operator.Add)
                .AddBlock(new int[] { 4, 3, 5, 3 }, 30, Operator.Multiply)
                .AddBlock(new int[] { 0, 4, 1, 4 }, 6, Operator.Multiply)
                .AddBlock(new int[] { 5, 4, 5, 5 }, 9, Operator.Add)
                .AddBlock(new int[] { 0, 5, 1, 5, 2, 5 }, 8, Operator.Add)
                .AddBlock(new int[] { 3, 5, 4, 5 }, 2, Operator.Divide);

            return kenKen;
        }

        public static Futoshiki CreateWikipediaFutoshiki()
        {
            Futoshiki wikipediaFutoshiki = new Futoshiki();
            wikipediaFutoshiki.SetValue(0, 1, 4).SetValue(4, 1, 2).SetValue(2, 2, 4).SetValue(4, 3, 4);
            wikipediaFutoshiki.AddGreaterThan(0, 0, 1, 0).AddGreaterThan(2, 0, 3, 0).AddGreaterThan(3, 0, 4, 0).
                AddGreaterThan(4, 3, 3, 3).AddGreaterThan(1, 4, 0, 4).AddGreaterThan(2, 4, 1, 4);
            return wikipediaFutoshiki;
        }
